...
rsc_evic_eff = [0.02, 0.04, 0.06, 0.08, 0.1, 0.12, 0.14, 0.16, 0.18, 0.2];
rsc_slide_eff = [0.5];
...
if (isnan(wt_data(1)))
    ...
    nuc_sum1 = run_simulation_from_genome(seq,'report',0, ...
        ...
        'RSC_evic_intensity', rsc_evic_eff(b), ...
        'RSC_slide_intensity', rsc_slide_eff(1), 'slide_len', 3, 'gen_len', genlen, n_steps, 10000);
