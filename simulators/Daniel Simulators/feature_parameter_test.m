...
plus1 = zeros(1,15);
minus1 = zeros(1,15);
plus1width = zeros(1,15);
minus1width = zeros(1,15);
ratio = zeros(1,15);
for j=1:15
    [likelihood(j), plus1(j), minus1(j), ~, plus1width(j), minus1width(j), ratio(j)] ...
...
legend('+1 width delta','-1 width delta','Likelihood / (-5)')
