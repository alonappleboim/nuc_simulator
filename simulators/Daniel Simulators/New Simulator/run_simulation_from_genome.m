...
params.nuc_a_rate = 0.01.*ones(1,gen_len); 
...
[params.nuc_e_rate, params.nuc_r_rate, params.nuc_l_rate] = ...
    generate_nuc_rates_from_sites(PolyA_sites, PolyT_sites, REB1_sites, ABF1_sites, RAP1_sites, ...
    params.nuc_width, params.REB1_width, params.ABF1_width, params.RAP1_width);
...
[peak_distance_1_2, peak_distance_2_3, tmp1, tmp2] = get_peak_distances(nuc_s_hist, [800:1200]);
