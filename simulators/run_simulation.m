...
% make NFRs
params.l_rate(inputs.NFR_pos(1) : inputs.NFR_pos((inputs.NFR_pos(end)-inputs.NFR_pos(1)) / 2)) = 30;
params.r_rate(inputs.NFR_pos((inputs.NFR_pos(end)-inputs.NFR_pos(1)) / 2) : inputs.NFR_pos(end)) = 30;
