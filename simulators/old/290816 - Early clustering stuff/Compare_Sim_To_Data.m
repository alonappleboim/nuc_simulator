function [ feature ] = Compare_Sim_To_Data( s_hist, data )
%Compare_Sim_To_Data a function for comparison between a simulation and the
...
prob_dist = sum(s_hist(5000:end, :)) ./ sum(sum(s_hist(5000:end, :)));
