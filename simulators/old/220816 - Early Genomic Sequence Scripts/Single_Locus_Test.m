...
%{
FRS2_PolyT_5temp(FRS2_PolyA > 4) = 1;
FRS2_PolyT_5temp(FRS2_PolyT > 4) = 1;
FRS2_PolyT_5temp = conv(FRS2_PolyT_5temp,ones(1,5),'same');
FRS2_PolyT_7temp(FRS2_PolyA > 6) = 1;
FRS2_PolyT_7temp(FRS2_PolyT > 6) = 1;
FRS2_PolyT_7temp = conv(FRS2_PolyT_7temp,ones(1,7),'same');
FRS2_PolyAT(FRS2_PolyT_5temp > 0) = 1;
FRS2_PolyAT(FRS2_PolyT_7temp > 0) = 2;
%}

% run a simulation with the PolyATs as parameters:
[s_hist, s_hist_coverage, peak_distance_1_2, peak_distance_2_3] = run_simulation_poly(FRS2_PolyAT, FRS2_PolyA, FRS2_PolyT, 'n_steps', 50000, 'linker_len', 40);
