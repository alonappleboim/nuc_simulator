...
tf_evic_eff = [0.0001];
rsc_length = [40, 45, 50, 55, 60, 65]; % this is the eviction length of RSC - the sliding length will be twice this
rsc_evic_eff = [0.02, 0.04, 0.07, 0.1, 0.2];
rsc_slide_eff = [2, 5, 10, 15, 20, 40, 70, 100]; % the ratio between slide and eviction
