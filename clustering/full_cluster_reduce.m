...
for i = 1:num_of_runs
	try
        load(['/cs/bd/Daniel/simulations/full_output_wt_021116/sim_' num2str(i) 'gene_' num2str(gene_index) '.mat']);
    catch a
        features(i,1) = nan;
        continue
    end
...
save(['/cs/bd/Daniel/simulations/full_output_wt_021116/results_' num2str(gene_index)] , ...
